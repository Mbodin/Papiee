<script lang="ts">
	...
	onMount(() => {
		...
		let rocq = "Definition A_ (n : nat) := n * (2 * n + 1) * (7 * n + 1).\n" ;
		rocq += "Lemma A_6 : \\forall n \\in \\mathbb{N}, \\exists a \\in \\mathbb{N}, A_ n = 3 * a.\n" ;
		rocq += "Proof.\n"
		...
		proof += "\t- Si $n \\bmod 3 = 0$. Il existe alors $k \\in \\mathbb{N}$ tel que $n = 3 * k$. Alors $A_ n = 3 * (k * (2 * n + 1) * (7 * n + 1))$.\n" ;
		proof += "\t- Si $n \\bmod 3 = 1$. Il existe alors $k \\in \\mathbb{N}$ tel que $n = 3 * k + 1$. Alors $2 * n + 1 = 3 * (2 * k + 1)$. Alors $A_ n = 3 * (n * (2 * k + 1) * (7 * n + 1)).$\n" ;
		proof += "\t- Si $n \\bmod 3 = 2$. Il existe alors $k \\in \\mathbb{N}$ tel que $n = 3 * k + 2$. Alors $7 * n + 1 = 3 * (7 * k + 5)$. Alors $A_ n = 3 * (n * (2 * n + 1) * (7 * k + 5)).$\n" ;
